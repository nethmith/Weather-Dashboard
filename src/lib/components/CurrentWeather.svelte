...
<div
	class="relative overflow-hidden rounded-3xl bg-white/30 dark:bg-slate-800/40 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-2xl p-8 text-slate-800 dark:text-slate-100 transition-all hover:shadow-orange-500/10"
>
	...
	<div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
		...
		<div class="flex flex-col items-center md:items-start text-center md:text-left space-y-2">
			<div class="flex items-baseline gap-2">
				...
				<span
					class="text-lg font-medium text-slate-500 dark:text-slate-400 bg-white/50 dark:bg-white/10 px-2 py-0.5 rounded-md"
				>
					{data.sys.country}
				</span>
			</div>
			...
			<div class="flex items-center mt-4">
				<span
					class="text-7xl md:text-8xl font-black tracking-tighter text-slate-800 dark:text-slate-100"
				>
			...
			<div class="flex flex-col gap-1">
				...
				<p class="text-sm text-slate-500 dark:text-slate-400">
					Feels like <span class="font-bold text-slate-700 dark:text-slate-300"
	...
	<div class="mt-8 grid grid-cols-3 gap-4 border-t border-white/20 dark:border-white/10 pt-8">
		<!-- Humidity -->
		<div class="flex flex-col items-center justify-center gap-1 text-center">
			<span class="text-slate-500 dark:text-slate-400 mb-1">
				<!-- Droplet Icon -->
				<svg
			...
			<span class="text-sm font-medium text-slate-500 dark:text-slate-400">Humidity</span>
			<span class="text-lg font-bold text-slate-800 dark:text-slate-200">{data.main.humidity}%</span
			>
		</div>
		...
		<div class="flex flex-col items-center justify-center gap-1 text-center">
			...
			<span class="text-sm font-medium text-slate-500 dark:text-slate-400">Wind</span>
			<span class="text-lg font-bold text-slate-800 dark:text-slate-200"
				>{Math.round(data.wind.speed * 3.6)} km/h</span
			>
		</div>
		...
		<div class="flex flex-col items-center justify-center gap-1 text-center">
			...
			<span class="text-sm font-medium text-slate-500 dark:text-slate-400">Pressure</span>
			<span class="text-lg font-bold text-slate-800 dark:text-slate-200"
